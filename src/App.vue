<template>
  <div>
    ...
    <form class="user-form" :class="{'hide': isHidden}" @submit.prevent="addUserName">
          <input class="user-input" name="user-input" placeholder="your name?" ref="userInput" autocomplete="off" v-model="userName" />    
    </form>
    ...
    <div>
        ...
        >
          <div class="message__container">
            ...
            <div v-if="message.messageType === 'image'">
              <img :src="require('./assets/' + message.message) " alt="">
            </div>
          </div>
        </li>
      </ul>
      ...
      <form id="form" @submit.prevent="sendMessage">
        <input id="input" ref="messageInput" autocomplete="off" v-model="message" />
        <div class="icon">
        <label for="upload">
          ...
          <input type="file" ref="file" id="upload" style="display:none" @change="selectFile">
        </label>
        </div>
      </form>
    </div>
